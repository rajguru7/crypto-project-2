...
class LocalRepository(Repository):
    ...
    def close(self, role_name: str, md: Metadata) -> None:
        ...
        targets = self.targets("unclaimed-package-signer")
    ...
    def add_target(self, role: str, targetpath: str, filepath: str, custom: Optional[dict] = None) -> bool:
        ...
        with contextlib.suppress(RepositoryError):
            ...
            # self.updater._load_targets("unclaimed-package-signer", "targets")

        # Robusto: fixing
        # data = bytes(targetpath, "utf-8")
        targetfile = TargetFile.from_file(targetpath, filepath)
    ...
    def add_delegation(self, role: str) -> bool:
        ...
        url = f"{self.base_url}/api/delegation/unclaimed/{role}"
